<template>
  <div>
    <div class="search-term">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">
        <el-form-item label="GPS序列号">
          <el-input v-model="searchInfo.gpsSn" placeholder="搜索条件" />
        </el-form-item>
    ...
    >
      ...
      <el-table-column label="GPS序列号" prop="gpsSn" width="120" />
      <el-table-column label="GPS名字" prop="gpsName" width="120" />
      <el-table-column label="busId字段" prop="busId" width="120" />
      <el-table-column label="按钮组">
        <template #default="scope">
          <el-button size="small" type="primary" icon="el-icon-edit" class="table-button" @click="updateGpsInfo(scope.row)">变更</el-button>
