<template>
  <div>
    <div class="search-term">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">
        <el-form-item label="站点名">
          <el-input v-model="searchInfo.locationName" placeholder="搜索条件" />
        </el-form-item>
    ...
    >
      ...
      <el-table-column label="站点名" prop="locationName" width="120" />
      <el-table-column label="routeId字段" prop="routeId" width="120" />
      <el-table-column label="经度" prop="longtitude" width="120" />
      <el-table-column label="纬度" prop="latitude" width="120" />
      <el-table-column label="站点在路线中的位置，第几站" prop="orderNo" width="120" />
      <el-table-column label="按钮组">
        <template #default="scope">
          <el-button size="small" type="primary" icon="el-icon-edit" class="table-button" @click="updateLocationInfo(scope.row)">变更</el-button>
