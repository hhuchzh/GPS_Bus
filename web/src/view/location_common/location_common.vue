    ...
    <div class="search-term">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">
        ...
        <el-form-item label="经度">
          <el-input v-model="searchInfo.longtitude" placeholder="搜索条件" />
        </el-form-item>
        <el-form-item>
    ...
    >
      ...
      <el-table-column label="按钮组">
        <template #default="scope">
          <el-button size="small" type="primary" icon="el-icon-edit" class="table-button" @click="updateLocationCommon(scope.row)">变更</el-button>
...
} from '@/api/location_common' //  此处请自行替换地址
