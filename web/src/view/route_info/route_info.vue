<template>
  <div>
    ...
    >
      ...
      <el-table-column label="路线名" prop="routeName" width="120" />
      <el-table-column label="起始地点" prop="startAddress" width="120" />
      <el-table-column label="结束地点" prop="endAddress" width="120" />
      <el-table-column label="大约时间" prop="aboutTime" width="120" />
      <el-table-column label="大约距离" prop="aboutDistance" width="120" />
      <el-table-column label="按钮组">
        <template #default="scope">
          <el-button size="small" type="primary" icon="el-icon-edit" class="table-button" @click="updateRouteInfo(scope.row)">变更</el-button>
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="弹窗操作">
      <el-form :model="formData" label-position="right" label-width="80px">
        ...
        <el-form-item label="大约时间:">
          <el-date-picker v-model="formData.aboutTime" type="date" placeholder="选择日期" clearable />
        </el-form-item>
